...
keeping each live MCP response bounded; call render eight times for the set.
"""
import bpy
import math
import json
...
def stage_model():
    if scene().get('modeled'):
        archive('Native framing review: extend separate sleeves to +Y0.80m; preserve finished body and prior candidates')
