...
The studio is in live operation. Every cycle is an update; the type fixes entry phase,
...
| **season / expansion** | new region, faction, major system | P2 worldview first | all 13 | G1–G8 | quarterly |
