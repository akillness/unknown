...
# `hints.json` 메타 — T0 인스턴스 데이터 (RFC-C7-001 · C7-F1)

**이 파일도 `hints.json` 도 손으로 쓰지 않는다.** 둘 다 아래 명령의 출력이며, 값의 출처는 각 필드 옆 `_src` 가 갖는다.
...
|---|---|
| 파생 | `projection` |
| sha256 | `8bbfc9318ee6decde387245482901959be04dfe28f74e0831d530ffbd9bb4839` |
| 바이트 (`wc -c`) | 4032 |
| 행 수 | 9 |
