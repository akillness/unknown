...
namespace Tide.Save {
 public static class JournalSave {
  ...
  public static JObject Encode(CommandJournal journal,string key,int entryCap,int byteCap,string saveId=null,string createdUtc=null,IReadOnlyDictionary<string,int> hintLevels=null){
